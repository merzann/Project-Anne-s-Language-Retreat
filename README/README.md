...
- __The Footer__ 
  ...
  - The footer also includes the contact details for the business with all important information potentially guest my need to contact the property
...
- The user experience is essential and to ensure the webpage meets the business needs I selected a group of people icluding the partner of the busniess and ask them to check the page to ensure the content included matches the expectation of potential guests. 
- The insides provided helped me to further improve the layout, pinpointing typos I had missed and also ensured the page is viewable and all the links actionable on different devices
...
- Katja Ehrsam for testing the code and the page thoroughly and helping me identify bugs I missed
- Mandy Seiler, Doris McCann, Patricia Wicke, Richard Kandler, Johh O'Shea, Sebatian Brovelii and Gudrun Michels for reviewing the website froma a customer's perspective and proving valuable Feedback
